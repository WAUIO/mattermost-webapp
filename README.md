...
Silicon Chat is an open source, self-hosted Slack-alternative from [https://mattermost.org](https://mattermost.org).
...
Try out Silicon Chat: 

- [Join the Silicon Chat Contributor's server](https://pre-release.mattermost.com/) (latest nightly builds, unstable)
- [Join the Silicon Chat Demo server](https://demo.mattermost.com) (latest stable version)
...
- [Join Developer Discussion on a Silicon Chat Server for contributors](https://pre-release.mattermost.com/signup_user_complete/?id=f1924a8db44ff3bb41c96424cdc20676)
...
- **Twitter** - Follow [Silicon ChatHQ](https://twitter.com/mattermosthq)
