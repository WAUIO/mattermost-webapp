...
class LicenseSettings extends React.Component {
    ...
    render() {
        ...
        if (this.props.license.IsLicensed === 'true') {
            ...
            edition = 'Silicon Chat Enterprise Edition. Enterprise features on this server have been unlocked with a license key and a valid subscription.';
            licenseType = (
                <div>
                    <p>
            ...
            edition = (
                <p>
                    {'Silicon Chat Enterprise Edition. Unlock enterprise features in this software through the purchase of a subscription from '}
                    <a
                        target='_blank'
                ...
                <div className='col-sm-8'>
                    ...
                    <p className='help-text no-margin'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='Upload a license key for Silicon Chat Enterprise Edition to upgrade this server. <a href="http://mattermost.com" target="_blank">Visit us online</a> to learn more about the benefits of Enterprise Edition or to purchase a key.'
                        />
                    </p>
                </div>
            );
