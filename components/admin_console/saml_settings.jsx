                ...
                <RemoveFileSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Remove the certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Silicon Chat is the Service Provider.'
                        />
                    }
                ...
                <FileUploadSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Silicon Chat is the Service Provider.'
                        />
                    }
                    uploadingText={Utils.localizeMessage('admin.saml.uploading.certificate', 'Uploading Certificate...')}
                    disabled={!this.state.enable || !this.state.encrypt}
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, Silicon Chat allows login using SAML 2.0. Please see <a href="http://docs.mattermost.com/deployment/sso-saml.html" target="_blank">documentation</a> to learn more about configuring SAML for Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The URL where Silicon Chat sends a SAML request to start login sequence.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When false, Silicon Chat will not verify that the signature sent from a SAML Response matches the Service Provider Login URL. Not recommended for production environments. For testing only.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When false, Silicon Chat will not decrypt SAML Assertions encrypted with your Service Provider Public Certificate. Not recommended for production environments. For testing only.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the email addresses of users in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the username field in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to bind users from SAML to users in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the first name of users in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the last name of users in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the nickname of users in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the position of users in Silicon Chat.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the language of users in Silicon Chat.'
                        />
                    }
