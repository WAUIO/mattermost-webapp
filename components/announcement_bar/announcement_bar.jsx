        ...
        if (this.state.type === BAR_ANNOUNCEMENT_TYPE) {
            ...
            message = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage={'Please check connection, Silicon Chat unreachable. If issue persists, ask administrator to [check WebSocket port](!https://about.mattermost.com/default-websocket-port-help).'}
                />
            );
            ...
            if (this.props.enableSignUpWithGitLab) {
                ...
                defaultMessage = 'Please configure your {docsLink} in the System Console or in gitlab.rb if you\'re using GitLab Silicon Chat.';
            } else {
