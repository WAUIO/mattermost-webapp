            ...
            confirmMessage: () => (
                <div className='alert alert-danger'>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='Any integrations using this token will no longer be able to access the Silicon Chat API. You cannot undo this action. <br /><br />Are you sure want to delete the {description} token?'
                        values={{
